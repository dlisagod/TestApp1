...
public final class SizeUtils {
    ...
    public static int getScreenHeight() {
        WindowManager wm = (WindowManager) (Utils.getApp().getSystemService
    ...
    public static int getScreenHeightNoStatusBar() {
        WindowManager wm = (WindowManager) (Utils.getApp().getSystemService
                (Context.WINDOW_SERVICE));
        return wm.getDefaultDisplay().getHeight()-getStatusBarHeight();
    }
    ...
    public static int getStatusBarHeight() {
        int result = 0;
        int resourceId = Utils.getApp().getResources().getIdentifier("status_bar_height", "dimen",
                "android");
        if (resourceId > 0) {
